...
public:
  ...
  void resetEncoders() {
    pcnt_counter_clear(PCNT_UNIT_LF);  
    pcnt_counter_clear(PCNT_UNIT_RI);  

    leftEncoderVirtualCount = 0;
    rightEncoderVirtualCount = 0;

    leftEncoderLastCount = 0;
    rightEncoderLastCount = 0;
  }
